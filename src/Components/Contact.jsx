...
function Contact() {
    return (
        <div className='w-full h-full'>
            <div className={`flex flex-col lg:flex-row  p-[2rem] m-[3rem] gap-4`}>
            <div className={`flex flex-1 flex-col gap-2 bg-black p-[2rem] shadow-[0_0_10px_white]`}>
              ...
              <p className="!text-left">Collaboration is at the heart of innovation. Whether you're a fellow developer or an HR professional looking for the right talent, let's connect, share ideas, and explore exciting opportunities together!</p>
            </div>
            <div className={`flex flex-1 flex-col gap-2 bg-black p-[2rem] shadow-[0_0_10px_white]`}>
          ...
          {/* <hr /> */}
          <div className="flex flex-col p-[3rem] m-[3rem] bg-black gap-[2rem]">
