...
function Projects() {
    ...
    },
    {
      ...
      techStack: ['Frontend: React.js', 'Styling: Tailwind CSS', 'State Management: useState & Context AP', 'Routing: React Route', 'Backend: Node.js + Express.js ', 'Backend: Node.js + Express.js ', 'Authentication & Security: JWT, bcrypt', ],
      myArr: imgArray3,
    },
